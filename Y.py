...
bot = telebot.TeleBot('7265371048:AAGRDG0i5jESsrZjUu71qsoslWTUD7yyN9')

# Owner user ID
owner_id = "1301017655"

# Admin user IDs
admin_ids = ["5241003518"]
    ...
    if user_id in allowed_user_ids:
        ...
        if user_id not in admin_ids and user_id != owner_id:
            ...
            if user_id in bgmi_cooldown and (datetime.datetime.now() - bgmi_cooldown[user_id]).seconds < 120:
                response = "You Are On Cooldown ❌. Please Wait 120sec Before Running The /attack Command Again."
                bot.reply_to(message, response)
                return
...
Buy From :- @the_yamraj
Official Channel :- https://t.me/+Z-jMNKFtCkczNDFl
'''
...
3. MAKE SURE YOU JOINED https://t.me/+Z-jMNKFtCkczNDFl OTHERWISE NOT WORK
...
def send_welcome(message):
    ...
    bot.send_message(message.chat.id, "Welcome To SHER || VIP Please choose an option:", reply_markup=markup)
